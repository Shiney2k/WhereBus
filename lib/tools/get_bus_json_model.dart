...
GetBusJsonModel getBusJsonModelFromJson(String str) => GetBusJsonModel.fromJson(json.decode(str));

String getBusJsonModelToJson(GetBusJsonModel data) => json.encode(data.toJson());
...
class GetBusJsonModel {
    ...
    factory GetBusJsonModel.fromJson(Map<String, dynamic> json) => GetBusJsonModel(
